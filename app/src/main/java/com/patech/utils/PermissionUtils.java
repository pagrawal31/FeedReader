...
public abstract class PermissionUtils {
    ...
    public static void requestPermission(AppCompatActivity activity, int requestId,
                                         String permission, String permissionRationale, boolean finishActivity) {
        if (ActivityCompat.shouldShowRequestPermissionRationale(activity, permission)) {
            // Display a dialog with rationale.
            RationaleDialog.newInstance(requestId, permission, permissionRationale,
                    finishActivity)
    ...
    public static class RationaleDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            String rationale = arguments.getString(ARGUMENT_PERMISSION_RATIONALE);
